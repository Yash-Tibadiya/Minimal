...
export const retellAiCallLogsRelations = relations(
  retellAiCallLogs,
  ({ one }) => ({
...
export const patientTreatmentPlansRelations = relations(
  patientTreatmentPlans,
  ({ one }) => ({
    patient: one(patients, {
...
export const adminTreatmentItemsRelations = relations(
  adminTreatmentItems,
  ({ one }) => ({
...
export const providerPrioritiesRelations = relations(
  providerPriorities,
  ({ one }) => ({
    user: one(users, {
...
export const providersServicePricingRelations = relations(
  providersServicePricing,
  ({ one }) => ({
    provider: one(providers, {
...
export const providerMedicalLicenseRelations = relations(
  providerMedicalLicense,
  ({ one }) => ({
    user: one(users, {
...
export const providerBusinessHoursRelations = relations(
  providerBusinessHours,
  ({ one }) => ({
    user: one(users, {
...
export const providerPaymentsRelations = relations(
  providerPayments,
  ({ one }) => ({
    provider: one(providers, {
...
export const patientIntakeFormsRelations = relations(
  patientIntakeForms,
  ({ one }) => ({
...
export const intakeFormConfigRelations = relations(
  intakeFormConfig,
  ({ many }) => ({
    patientIntakeForms: many(patientIntakeForms),
  })
...
export const notificationTimingRelations = relations(
  notificationTiming,
  ({ one }) => ({
    notificationSetting: one(notificationSettings, {
