import { pgTable, index, serial, integer, varchar, text, json, timestamp, unique, boolean, jsonb, foreignKey, real, uniqueIndex, numeric, bigint, smallint, date, pgEnum } from "drizzle-orm/pg-core"
...
export const activityLogs = pgTable("activity_logs", {
	...
	index("activity_log_user_action_idx").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.action.asc().nullsLast().op("text_ops")),
...
export const intakeFormConfig = pgTable("intake_form_config", {
	...
	unique("intake_form_config_code_unique").on(table.code),
]);
...
export const brands = pgTable("brands", {
	...
	brandCode: varchar("brand_code", { length: 255 }).default('leafyrx'),
...
export const notificationTemplates = pgTable("notification_templates", {
	...
	brandCode: varchar("brand_code", { length: 50 }).default('leafyrx').notNull(),
