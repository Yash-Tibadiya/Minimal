...
CREATE TABLE "patient_plans" (
	...
	"next_refill_due_date" timestamp,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp,
...
CREATE TABLE "caller_numbers" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp,
	"brand_code" varchar(255) DEFAULT 'wellnesswag',
	"agent_name" varchar(255),
	"agent_id" varchar(255),
	"is_renewals" boolean DEFAULT false,
...
CREATE TABLE "notification_templates" (
	...
	"brand_code" varchar(50) DEFAULT 'minimal' NOT NULL,
...
CREATE TABLE "intake_form_templates" (
	...
	"consent_sign_url" varchar(512),
	"preview_content" text,
	"require_consent" boolean DEFAULT false,
	"pdf_description" text,
	"show_thankyou_page" boolean DEFAULT false,
	"form_submit_back_link" varchar(255),
	"review_description" text,
	"form_submitted_content" text,
	...
	"updated_at" timestamp,
	"deleted_at" timestamp,
	CONSTRAINT "intake_form_templates_code_unique" UNIQUE("code")
);
--> statement-breakpoint
...
CREATE TABLE "plans" (
	...
	"name" varchar(255) NOT NULL,
	"package" varchar(255),
	"first_prescription_discount_amount" numeric(10, 2),
	"default_service_type" varchar(255),
	"is_active" boolean DEFAULT true,
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp,
...
ALTER TABLE "patient_plans" ADD CONSTRAINT "patient_plans_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "patient_plans" ADD CONSTRAINT "patient_plans_patient_id_patients_id_fk" FOREIGN KEY ("patient_id") REFERENCES "public"."patients"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "patient_plans" ADD CONSTRAINT "patient_plans_plan_id_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_patient_plan_id_patient_plans_id_fk" FOREIGN KEY ("patient_plan_id") REFERENCES "public"."patient_plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_current_medication_id_medications_id_fk" FOREIGN KEY ("current_medication_id") REFERENCES "public"."medications"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "intake_form_templates" ADD CONSTRAINT "intake_form_templates_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "intake_form_templates" ADD CONSTRAINT "intake_form_templates_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "intake_form_templates" ADD CONSTRAINT "intake_form_templates_updated_by_users_id_fk" FOREIGN KEY ("updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "medications" ADD CONSTRAINT "medications_plan_id_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "plans" ADD CONSTRAINT "plans_medication_id_medications_id_fk" FOREIGN KEY ("medication_id") REFERENCES "public"."medications"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "prescriptions" ADD CONSTRAINT "prescriptions_plan_id_plans_id_fk" FOREIGN KEY ("plan_id") REFERENCES "public"."plans"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "prescriptions" ADD CONSTRAINT "prescriptions_refill_medication_id_medications_id_fk" FOREIGN KEY ("refill_medication_id") REFERENCES "public"."medications"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "activity_log_user_action_idx" ON "activity_logs" USING btree ("user_id" int4_ops,"action" text_ops);--> statement-breakpoint
...
CREATE INDEX "patient_plans_category_id_idx" ON "patient_plans" USING btree ("category_id" int4_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_current_medication_id_idx" ON "patient_plans" USING btree ("medication_id" int4_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_next_refill_due_date_idx" ON "patient_plans" USING btree ("next_refill_due_date" timestamp_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_patient_id_idx" ON "patient_plans" USING btree ("patient_id" int4_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_plan_id_idx" ON "patient_plans" USING btree ("plan_id" int4_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_prescription_id_idx" ON "patient_plans" USING btree ("prescription_id" int4_ops);--> statement-breakpoint
CREATE INDEX "patient_plans_status_idx" ON "patient_plans" USING btree ("status" text_ops);--> statement-breakpoint
...
CREATE INDEX "task_category_id_idx" ON "tasks" USING btree ("category_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "task_generic_title_idx" ON "tasks" USING btree ("generic_title" text_ops);--> statement-breakpoint
...
CREATE INDEX "task_patient_plan_id_idx" ON "tasks" USING btree ("patient_plan_id" int4_ops);--> statement-breakpoint
CREATE INDEX "task_payment_status_idx" ON "tasks" USING btree ("payment_status" text_ops);--> statement-breakpoint
CREATE INDEX "task_plan_id_idx" ON "tasks" USING btree ("plan_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "brand_code_idx" ON "brands" USING btree ("brand_code" text_ops);--> statement-breakpoint
...
CREATE INDEX "intake_form_templates_category_id_idx" ON "intake_form_templates" USING btree ("category_id" int4_ops);--> statement-breakpoint
CREATE INDEX "intake_form_templates_code_idx" ON "intake_form_templates" USING btree ("code" text_ops);--> statement-breakpoint
CREATE INDEX "intake_form_templates_is_published_idx" ON "intake_form_templates" USING btree ("is_published" bool_ops);--> statement-breakpoint
CREATE INDEX "categories_code_idx" ON "categories" USING btree ("code" text_ops);--> statement-breakpoint
CREATE INDEX "categories_is_active_idx" ON "categories" USING btree ("is_active" bool_ops);--> statement-breakpoint
...
CREATE INDEX "medications_plan_id_idx" ON "medications" USING btree ("plan_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "plans_category_id_idx" ON "plans" USING btree ("category_id" int4_ops);--> statement-breakpoint
CREATE INDEX "plans_is_active_idx" ON "plans" USING btree ("is_active" bool_ops);--> statement-breakpoint
CREATE INDEX "plans_name_idx" ON "plans" USING btree ("name" text_ops);--> statement-breakpoint
CREATE INDEX "plans_package_idx" ON "plans" USING btree ("package" text_ops);--> statement-breakpoint
...
CREATE INDEX "medication_variants_dosage_idx" ON "prescriptions" USING btree ("dosage" text_ops);--> statement-breakpoint
CREATE INDEX "medication_variants_medication_id_idx" ON "prescriptions" USING btree ("medication_id" int4_ops);--> statement-breakpoint
CREATE INDEX "medication_variants_plan_id_idx" ON "prescriptions" USING btree ("plan_id" int4_ops);
*/